...
def test_allowed_actions_operations(ai_wallet, ai_wallet_config, owner, bravo_token, agent, mock_lego_alpha, alpha_token, alpha_token_erc4626_vault, alpha_token_whale, sally):
