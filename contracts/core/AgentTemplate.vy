...
BATCH_ACTIONS_TYPE_HASH: constant(bytes32) = keccak256('performBatchActions(address userWallet,ActionInstruction[] instructions,uint256 expiration)')
