...
VAULT_TOKENS = {
    "usdc": {
        "base": YIELD_TOKENS["base"]["MORPHO_MOONWELL_USDC"],
        "local": ZERO_ADDRESS,
    },
    "weth": {
        "base": YIELD_TOKENS["base"]["MORPHO_MOONWELL_WETH"],
        "local": ZERO_ADDRESS,
    },
    "eurc": {
        "base": YIELD_TOKENS["base"]["MORPHO_MOONWELL_EURC"],
        "local": ZERO_ADDRESS,
    },
    "cbbtc": {
        "base": YIELD_TOKENS["base"]["MORPHO_MOONWELL_CBBTC"],
        "local": ZERO_ADDRESS,
    },
}
