...
CLAIM_REWARDS_UINT256 = 2**CLAIM_REWARDS_INDEX  # 2 ** 8 = 256
BORROW_UINT256 = 2**BORROW_INDEX  # 2 ** 9 = 512
REPAY_UINT256 = 2**REPAY_INDEX  # 2 ** 10 = 1024
...
# migration limits
MAX_MIGRATION_ASSETS = 40
MAX_MIGRATION_WHITELIST = 20